...
#Save comp
#comp.to_csv(dir_path=os.path.join('.', '04_Results'), file_name=f'econci_comp_HS{HS_code_level}_2023.csv')
...
econci.edges_nodes_to_csv(prod_space, graph_name=f'prod_space{HS_code_level}', dir_path='./04_Results/')
'''
