...
def CSV_creatorHS22(supplementary, year, excel_path):
    if supplementary == 1:
...
def CSV_creatorHS96(supplementary, year, excel_pathHS96):
...
def CSV_creatorHS17(supplementary, year, excel_pathHS17):
