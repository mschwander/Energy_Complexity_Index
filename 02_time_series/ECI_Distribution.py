...
def ECI_Distribution(cdata, supplementary, year, save_folder):
    ...
    if supplementary:
        plt.title(f"Scatter Plot of Energy Complexity Index by Country ({year}) (supplementary Dataset)")
    else:
    ...
    if supplementary:
        plt.title(f"Histogram of Energy Complexity Index Values ({year}) (supplementary Dataset)")
    else:
    ...
    if supplementary:
        plt.title(f"Density Plot of Energy Complexity Index Values ({year}) (supplementary Dataset)")
    else:
